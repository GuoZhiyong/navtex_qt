...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Apr 8 13:22:09 2014
...
compiler_moc_header_make_all: moc_qextserialport.cpp moc_qextserialenumerator.cpp moc_panel_info.cpp moc_panel_about.cpp moc_panel_item.cpp moc_panel_setup.cpp moc_panel_detail.cpp moc_mainwin.cpp moc_common.cpp moc_eventspy.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qextserialport.cpp moc_qextserialenumerator.cpp moc_panel_info.cpp moc_panel_about.cpp moc_panel_item.cpp moc_panel_setup.cpp moc_panel_detail.cpp moc_mainwin.cpp moc_common.cpp moc_eventspy.cpp
...
moc_common.cpp: common.h
	/opt/EmbedSky/qt-4.8.5/__install/arm//bin/moc $(DEFINES) $(INCPATH) common.h -o moc_common.cpp

...
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? 4? 17 10:40:09 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/navtex1.0.0/ && $(COPY_FILE) --parents 3rdparty/qextserialport/src/qextserialport.h 3rdparty/qextserialport/src/qextserialenumerator.h 3rdparty/qextserialport/src/qextserialport_global.h 3rdparty/qextserialport/src/qextserialport_p.h 3rdparty/qextserialport/src/qextserialenumerator_p.h FlowLayout.hpp panel_info.h panel_about.h panel_item.h panel_setup.h panel_detail.h mainwin.h common.h .tmp/navtex1.0.0/ && $(COPY_FILE) --parents res.qrc .tmp/navtex1.0.0/ && $(COPY_FILE) --parents 3rdparty/qextserialport/src/qextserialport.cpp 3rdparty/qextserialport/src/qextserialenumerator.cpp 3rdparty/qextserialport/src/qextserialport_unix.cpp 3rdparty/qextserialport/src/qextserialenumerator_linux.cpp main.cpp FlowLayout.cpp panel_info.cpp panel_about.cpp panel_item.cpp panel_setup.cpp panel_detail.cpp mainwin.cpp common.cpp .tmp/navtex1.0.0/ && $(COPY_FILE) --parents panel_item.ui panel_detail.ui .tmp/navtex1.0.0/ && (cd `dirname .tmp/navtex1.0.0` && $(TAR) navtex1.0.0.tar navtex1.0.0 && $(COMPRESS) navtex1.0.0.tar) && $(MOVE) `dirname .tmp/navtex1.0.0`/navtex1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/navtex1.0.0
